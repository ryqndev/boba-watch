...
const Dashboard = () => {
    ...
    return (
        <div className="dashboard-page">
            ...
            <Card className="limit" style={{backgroundPositionY: (100 - parseInt((metrics.td / user.profile.limit) * 100)) * 2.7}}>
                <h3 className="bw">{parseInt((metrics.td / user.profile.limit) * 100)}%</h3>
