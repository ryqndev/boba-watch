...
const FeedItem = ({
	...
	useEffect(() => {
		...
		(async () => {
			setImageAttr(await getImageAttribute(post.image, 'thumbnail'));
		})();
	}, [post.image]);
	...
	return (
		<Card className='feed-item'>
			<div className='header'>
				...
				<p className='favorite-amount'></p>
				<div className='favorite'></div>
			</div>
			<div
				className={`feed-item-content--base item-content${
					imageAttr ? '--with-image' : ''
				}`}
			>
				{imageAttr && (
					<img
...
export const FeedItemWithAvatar = WithAvatar;
